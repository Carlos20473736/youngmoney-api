    ...
    case 'POST':
        try {
            ...
            if (!isset($data['user_id']) || !isset($data['pix_key']) || !isset($data['pix_key_type']) || !isset($data['amount'])) {
                http_response_code(400);
                echo json_encode(['status' => 'success', 'data' => ['success' => false, 'error' => 'Dados incompletos']]);
                exit;
            }
            ...
            if ($amountBrl < 1) {
                http_response_code(400);
                echo json_encode(['status' => 'success', 'data' => ['success' => false, 'error' => 'Valor mínimo: R$ 1,00']]);
                exit;
            }
            ...
            if ($currentPoints < $pointsRequired) {
                http_response_code(400);
                echo json_encode(['status' => 'success', 'data' => ['success' => false, 
            ...
            echo json_encode(['status' => 'success', 'data' => ['success' => false, 'error' => 'Erro ao processar saque: ' . $e->getMessage()]]);
        }
        break;
